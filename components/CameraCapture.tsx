    ...
    async function takePhoto() {
        ...
        try {
            ...
            */
            ...
            const gpsError = locationError as GeolocationPositionError;

            if (gpsError.code === 1) {
                setError(
                    "GPS 오류 1: Safari에서 위치 사용이 거부되었습니다."
                );
                return;
            }
            ...
            if (gpsError.code === 2) {
                setError(
                    "GPS 오류 2: 현재 위치 정보를 수신하지 못했습니다. 잠시 후 다시 촬영해주세요."
                );
                return;
            }
            ...
            if (gpsError.code === 3) {
                setError(
                    "GPS 오류 3: 위치 확인 시간이 초과되었습니다. 실외나 창가에서 다시 시도해주세요."
                );
                return;
            }

            setError(
                `GPS 오류: 위치를 확인하지 못했습니다. ${gpsError.message || ""}`
            );
        }
    }
